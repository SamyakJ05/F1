...
export default function ApexExperience() {
  ...
  return <main>
    ...
    <footer><div className="footer-brand"><a className="wordmark" href="#top"><i />APEX <span>ATLAS</span></a><p>An independent field guide to motorsport technology, circuits and racecraft.</p></div><div className="footer-links"><div><b>EXPLORE</b><a href="#circuits">Circuit Atlas</a><a href="#machine">Car Lab</a><a href="#strategy">Strategy Studio</a></div><div><b>ABOUT</b><a href="/about">Our approach</a><a href="/privacy">Privacy</a><a href="/terms">Terms</a></div></div><div className="footer-meta"><span>© 2026 APEX ATLAS</span><span>INDEPENDENT. UNOFFICIAL. BUILT FOR THE CURIOUS.</span></div></footer>
  </main>;
}
